...
echo ============================================
echo  Step 1: Build native DLL (plugin_core.dll) [x64]
echo ============================================

if not exist build_plugin_x64 mkdir build_plugin_x64

cmake -S . -B build_plugin_x64 -G Ninja -DCMAKE_BUILD_TYPE=Release -DCMAKE_C_COMPILER=clang -DCMAKE_CXX_COMPILER=clang++ -DCMAKE_LINKER=lld-link -DCMAKE_C_COMPILER_TARGET=x86_64-pc-windows-msvc -DCMAKE_CXX_COMPILER_TARGET=x86_64-pc-windows-msvc -DTARGET_ARCH=x64 -DCMAKE_EXPORT_COMPILE_COMMANDS=ON
if errorlevel 1 goto :fail

ninja -C build_plugin_x64 plugin_core
if errorlevel 1 goto :fail
...
echo.
echo ============================================
echo  Build complete! [x64] v%GOTOSLOP_VERSION%
echo ============================================
echo VSIX: %VSIX_PATH%
